...
$successFileInfo = (docker exec -it namenode hdfs dfs -ls hdfs://namenode:8020/data_hub/data/lake/client-pohjola/dept1/data_spec_rim/yields/converted/ds_calypso/_SUCCESS)
